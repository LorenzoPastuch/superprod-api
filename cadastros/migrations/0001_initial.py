    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horainicial', models.CharField(blank=True, max_length=100)),
                ('horafinal', models.CharField(blank=True, max_length=100)),
                ('quantidade', models.IntegerField()),
                ('perda', models.FloatField(blank=True)),
                ('motivoperda', models.CharField(blank=True, max_length=100)),
                ('ciclo', models.FloatField(blank=True)),
